...
**At a glance**: The AppsFlyer PC/Console/CTV API allows advertisers to measure first app opens (installs), in-app events, and sessions via server-to-server API. All calls are made via secure HTTP.
...
## Integrate AppsFlyer PC/Console/CTV API
...
2. Set up the events for AppsFlyer.
