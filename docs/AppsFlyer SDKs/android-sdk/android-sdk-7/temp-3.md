...
**Step 1: Declare repositories**<br />In the Project `build.gradle` file, declare the `mavenCentral` repository:
...
**Step 2: Add dependencies**<br />In the application `build.gradle` file, add the [latest Android SDK](https://mvnrepository.com/artifact/com.appsflyer/af-android-sdk) package:
...
### The AD\_ID permission

Starting `V6.8.0`, the SDK adds the AD\_ID permission automatically.

> 📘 Note
>
> If your app participates in the [Designed for Families](https://support.google.com/googleplay/android-developer/topic/9877766?hl=en\&ref_topic=9858052) program, you should review the AD\_ID permission.
...
Samsung, Xiaomi, and Huawei store referrer support is no longer bundled in the main `af-android-sdk` artifact in SDK V7. If you distribute your app through any of these stores and need that referrer data, add the corresponding library as a separate Gradle dependency.
