...
{
  "type": "info",
  "title": "Github repository for this plugin is [here](https://github.com/AppsFlyerSDK/appsflyer-unity-plugin)"
}
[/block]
...
- [Integration](/docs/basicintegration)
- [Test integration](/docs/testing)
- [In-app events](/docs/inappevents)
- [Uninstall measurement](/docs/uninstallmeasurement)
## 🌟 Deep Linking
- [Integration](/docs/deeplinkintegrate)
- [Unified Deep Link (UDL)](/docs/unifieddeeplink)
- [User invite](/docs/userinvite)
