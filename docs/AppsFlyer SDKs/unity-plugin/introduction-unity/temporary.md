...
**Step 1: Import dependencies**<br />In your `AppDelegate`, import `AppsFlyerLib`:
...
**Step 2: Initialize the SDK**<br />In `didFinishLaunchingWithOptions`, initialize the SDK with your dev key and Apple App ID:
...
| `prefix`                    | String            | `""`    | _(set together with&#x20;_`host`_)_                             |
