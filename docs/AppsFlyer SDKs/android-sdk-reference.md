 ...
 * `com.appsflyer`
    ...
    * `share`
      ...
      * [`ShareInviteHelper`](doc:android-sdk-reference-shareshareinvitehelper): Helper class to create user invite URLs.
      * [`LinkGenerator`](doc:android-sdk-reference-sharelinkgenerator): Object used to create single-platform and OneLink URLs.
