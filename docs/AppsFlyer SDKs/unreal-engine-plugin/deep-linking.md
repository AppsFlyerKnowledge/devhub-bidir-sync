...
---
title: Deep Linking
category: 660595bf273e8e000f923e51
parentDoc: 660595bf273e8e000f924022
order: 3
hidden: true
...
1. Create a new Actor object.
   ...
   ![alt-text](https://files.readme.io/83370fb-AddNewActor.png)
   <img src="https://files.readme.io/83370fb-AddNewActor.png"   style="text-align: left; width: 456px; padding: 5px"/>

2. Click **Add Component** and the **AppsFlyer SDKCallback** Component.  

   [block:image]{"images":[{"image":["https://files.readme.io/698d455-AddComponent.png",null,null],"align":"center","sizing":"456px"}]}[/block]
