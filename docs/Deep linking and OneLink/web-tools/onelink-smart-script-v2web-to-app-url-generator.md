---
title: OneLink Smart Script V2—Web-to-app URL generator
excerpt: ''
deprecated: false
hidden: true
metadata:
...
{
  "type": "danger",
  "title": "This page has a newer [version](https://dev.appsflyer.com/hc/docs/dl_smart_script_v2)"
}
[/block]
...
[block:tutorial-tile]
{
  ...
  "_id": "63d045aa5e96a40046514654",
  "id": "63d045aa5e96a40046514654",
...
The Smart Script initialization and calling code can be either come from the [Smart Script generator](https://dev.appsflyer.com/hc/docs/onelink-smart-script-v2web-to-app-url-generator#use-code-generated-by-the-smart-script-generator) in the AppsFlyer dashboard (**recommended**), or [imported and called manually](https://dev.appsflyer.com/hc/docs/onelink-smart-script-v2web-to-app-url-generator#manually-configure-the-script) by the developer.
...
See [example](https://appsflyersdk.github.io/appsflyer-onelink-smart-script/examples/referrer_skip_list.html?incmp=gogo&inmedia=email) of how you can disable the Smart Script for a particular click (for example, from Twitter or Facebook) by creating a skip list. If any of the strings in the skip list appear in the HTTP referrer of the click, the Smart Script returns `null`.
...
See [example](https://appsflyersdk.github.io/appsflyer-onelink-smart-script/examples/impressions.html?incmp=gogo&inmedia=email) of an impression.