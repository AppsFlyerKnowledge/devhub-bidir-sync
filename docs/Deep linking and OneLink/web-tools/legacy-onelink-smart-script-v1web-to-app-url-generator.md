---
title: '[Legacy] OneLink Smart Script V1—Web-to-app URL generator'
excerpt: ''
deprecated: false
hidden: true
metadata:
...
next:
  description: ''
---
> ❗️ This page has a newer [version](https://dev.appsflyer.com/hc/docs/dl_legacy_smart_script_v1)
...
![](https://files.readme.io/2b7e970-7901_Smart_Script_flow_1920x1080_2_1.png "7901 Smart Script flow 1920x1080 2 (1).png")
...
[block:embed]
{
  ...
  "href": "https://appsflyer.wistia.com/medias/peqytyburo"
}
[/block]
...
| 2. Initialize the Smart Script object [OneLinkUrlGenerator](doc:onelinkurlgenerator) with the parameters and values. |
