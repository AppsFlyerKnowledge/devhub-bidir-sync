...
next:
  description: ''
---
> ❗️ This page has a newer [version](https://dev.appsflyer.com/hc/docs/dl_ios_init_setup)
...
![](https://files.readme.io/18804c2-direct_and_deferred_deep_linking.png "direct and deferred deep linking.png")

## App opening methods

There are two app-opening methods that need to be implemented to cover your entire user base. The method used depends on the mobile platform version and platform.
...
[block:parameters]
{
  "data": {
    ...
    "1-2": "[iOS all versions](https://support.appsflyer.com/hc/en-us/articles/115002366466)",
...
2. On the left-hand menu, select **_Certificates, Identifiers & Profiles_**.
3. Under **_Identifiers_**, select **_App IDs_**.
...
![](https://files.readme.io/6b67004-certs_apple_info.png "certs_apple_info.png")
...
4. Switch to **_Capabilities_** tab.
5. Turn on **_Associated Domain_**.
6. Add the subdomain that you got from your marketer.  
   The format is **applinks:subdomain.onelink.me**

![](https://files.readme.io/ed37397-xcode-associated-domains.png "xcode-associated-domains.png")
...
![](https://files.readme.io/569ae8d-info_list_uri_schemes.png "info_list_uri_schemes.png")
...
![](https://files.readme.io/4bdb9ef-885402320830842.XbZXy5YrCSL3FKIBZPjn_height640.png "885402320830842.XbZXy5YrCSL3FKIBZPjn_height640.png")