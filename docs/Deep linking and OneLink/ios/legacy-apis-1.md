...
next:
  description: ''
---
> ❗️ This page has a newer [version](https://dev.appsflyer.com/hc/docs/dl_ios_gcd_legacy)
...
![](https://files.readme.io/236078e-ddl_iOS.png "ddl_iOS.png")
...
![](https://files.readme.io/2407f56-Ios_DL.png "Ios_DL.png")
...
| 4. [Implementing the `onAppOpenAttributionFailure()` logic](https://dev.appsflyer.com/hc/docs/ios-legacy-apis#implementing-onappopenattributionfailure-logic)                          |
...
![](https://files.readme.io/4db3218-Ios_DDL.png "Ios_DDL.png")
...
4. iOS verifies the Universal Link ownership using the _Apple App Site Association_ file hosted by AppsFlyer in the location: `https://myapp.onelink.me/.well-known/apple-app-site-association`
...
[block:parameters]
{
  "data": {
    ...
    "6-0": "host",
    "6-1": "String",
    "6-2": "Identifies the host that holds the resource. For example: mygreatapp://**mainactivity** or  \n[https://**killerapp.onelink.me**/coolactivity/H7JK](https://**killerapp.onelink.me**/coolactivity/H7JK)",
    "6-3": "**Deprecated**",
    "7-0": "path",
    "7-1": "String",
    "7-2": "The specific resource in the host that the web client wants to access. For example:  [https://killerapp.onelink.me/coolactivity/**H7JK**](https://killerapp.onelink.me/coolactivity/**H7JK**)",
    "7-3": "**Deprecated**  \nNot relevant for URI schemes",
    "8-0": "shortlink",
    "8-1": "String",
    "8-2": "A shortened URL, with significantly fewer characters than the original link. For example: [https://killerapp.onelink.me/coolactivity/H7JK/**checkitout**](https://killerapp.onelink.me/coolactivity/H7JK/**checkitout**)",
    "8-3": "",
    "9-0": "af_web_id",
    "9-1": "String",
