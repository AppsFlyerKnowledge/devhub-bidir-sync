...
next:
  description: ''
---
> ❗️ This page has a newer [version](https://dev.appsflyer.com/hc/docs/dl_android_init_setup)
...
> 📘 The marketer will give you an auto-generated intent-filter code.
> 
> The intent-filter code is used in the AndroidManifest.XML.
...
> - The URI scheme should not start with _http_ or _https_.
> - The URI scheme should be similarly defined on Android and iOS.

> 👍 URI scheme should be supplied to the marketer
> 
> Send the URI scheme to the marketer, e.g. `afshopapp://mainactivity`
