...
{
  "type": "danger",
  "title": "This page has a newer [version](https://dev.appsflyer.com/hc/docs/dl_android_init_setup)"
}
[/block]
**At a glance**: The initial app setup enables the marketer to create links that will send existing app users directly into the app. The initial setup is also a prerequisite for deep linking and deferred deep-linking.
[block:api-header]
{
  "title": "App opening methods"
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "h-3": "Procedure",
    "0-3": "1. [Generate SHA256 fingerprint.](https://dev.appsflyer.com/hc/docs/initial-setup-for-deep-linking-and-deferred-deep-linking#generating-a-sha256-fingerprint)\n2. [Add intent-filter to main activity.](https://dev.appsflyer.com/hc/docs/initial-setup-for-deep-linking-and-deferred-deep-linking#adding-app-link-intent-filter-to-main-activity)",
    "1-3": "1. [Decide on a URI scheme with the marketer.](https://dev.appsflyer.com/hc/docs/initial-setup-for-deep-linking-and-deferred-deep-linking#deciding-on-a-uri-scheme)\n2. [Add intent-filter to main activity.](https://dev.appsflyer.com/hc/docs/initial-setup-for-deep-linking-and-deferred-deep-linking#adding-uri-scheme-intent-filter-to-main-activity)\n3. [Testing](https://dev.appsflyer.com/hc/docs/initial-setup-for-deep-linking-and-deferred-deep-linking#testing-uri-schemes)"
  },
  "cols": 4,
  "rows": 2
}
