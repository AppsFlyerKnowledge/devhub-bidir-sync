...
See [example](https://appsflyersdk.github.io/appsflyer-onelink-smart-script/examples/impressions_mobile.html?incmp=gogo&inmedia=email) of an impressions fired from a mobile device.
...
### Impressions - Cross platform

See [example](https://appsflyersdk.github.io/appsflyer-onelink-smart-script/examples/impressions_cross_platform.html?incmp=gogo&inmedia=email) of an impressions fired from a non-mobile platform (e.g desktop or console).
