...
**Before you begin**: Make sure you and the marketer have already created a OneLink template with <Anchor target="_blank" href="https://dev.appsflyer.com/hc/docs/dl_ios_init_setup#app-opening-methods">Universal Links</Anchor> and a OneLink custom link set up to direct your full-app users. With the template and custom link already configured, AppsFlyer automatically hosts and edits the AASA file to support App Clips. **Note**: It may take several hours for the AASA file to update.
...
5. Add the following code to `sceneDelegate`:
   ...
   ⇲ Github links: [Swift](https://github.com/AppsFlyerSDK/appsflyer-apple-app-clips-sample-app/blob/01f91d8052f89baf27ad9b750e718e20b1b9d155/Fruit%20AppClip/SceneDelegate.swift#L18-L32)
...
7) Let the marketer know that the SDK integration is completed, and tell them to implement the App Clip experience in the OneLink custom link and App Store Connect. [Learn more](https://support.appsflyer.com/hc/en-us/articles/360014262358-Apple-App-Clips-integration-guide#app-clip-implementation)
   <Callout icon="📘" theme="info">
     ...
     [View our App Clip](https://github.com/AppsFlyerSDK/appsflyer-apple-app-clips-sample-app) that demonstrates the AppsFlyer app clip integration.
   </Callout>
