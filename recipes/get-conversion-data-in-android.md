...
# Import AppsFlyerConversionListener library
...
# Add the conversion Listener to init

<!-- java@57 -->

Add the the conversion listener created to the second argument of `init`
...
The input parameters are listed [here](https://dev.appsflyer.com/hc/docs/android-sample-payloads).
